...
def creer_briques(niveau):
    ...
    for i in range(7 + niveau):  # Augmente le nombre de briques avec le niveau
        for j in range(5):
...
# Fonction pour gérer l'écran "Game Over"
            ...
            while True:
                for evenement in pygame.event.get():
                    ...
                    if evenement.type == pygame.KEYDOWN and evenement.key == pygame.K_r:
                        return boucle_jeu(niveau)  # Recommencer le jeu avec le même niveau
